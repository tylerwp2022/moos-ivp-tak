...
void showSynopsis()
{
  ...
  blk("      shapes are filtered via shoreside=true + vehicle_names.  ");
}
...
void showExampleConfigAndExit()
{
  ...
  blk("  // name. vehicle_names uses $(VNAMES) from launch_shoreside.sh ");
  blk("  // so it automatically matches the current team configuration. ");
  blk("  // shoreside  = true                                           ");
  blk("  // vehicle_names = $(VNAMES)  // red_one:red_two:...:blue_one  ");
  blk("                                                                ");
  blk("  // Legacy alternative (if vehicle_names not available):       ");
  blk("  // label_block_contains = loiter,opreg,wpt,trackpt            ");
  blk("                                                                ");
  blu("  debug = false                                                 ");
  blk("}                                                               ");
  blk("                                                                ");
